package cn.itweknow.sbrpccorestarter.exception;
...
public class HandleMessageException extends Exception {
     ...
     * @since 1.7
     */
    public HandleMessageException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
