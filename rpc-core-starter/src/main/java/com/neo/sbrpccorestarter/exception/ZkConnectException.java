package com.neo.sbrpccorestarter.exception;
...
public class ZkConnectException extends Exception {
     ...
     * @since 1.7
     */
    protected ZkConnectException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
